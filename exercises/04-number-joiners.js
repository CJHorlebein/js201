...
function numberJoinerWhile(start, finish){
    // lists numbers from start to finish using a seperator
    var res = "";
    while(start < finish){
        res += start + "_";
        start++;
...
function numberJoinerFancy(start, finish, sep){
    // lists numbers from start to finish
    // sets default seperator if missing
    var res = "";
    if(!sep){
        sep = "_"
    }
